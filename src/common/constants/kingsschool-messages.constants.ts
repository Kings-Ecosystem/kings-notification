...
export const KingsSchoolEmailTemplates = {
  adminAccount: (data: Partial<IUser>) => {
    ...
    => <strong>School Grading/Reports management:</strong> Manage learning grading system and report card generation<br><br>
...
=> <strong>Login:</strong> Visit <a href="https://sms.ksoftinc.com">kingsschool</a> and enter your username and password to login.<br><br>
